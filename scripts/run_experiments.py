...
def run():
    ...
    landscape,meta=prepare(src,src/'InRaster/cosecha24.tif')
    ...
    for row in configurations:
        ...
        result,diagnostics=simulate(landscape['initial'],landscape['reporting_mask'],landscape['scheduled_year'],eligibility(landscape,p),p,draws)
