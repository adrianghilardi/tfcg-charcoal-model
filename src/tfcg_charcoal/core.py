...
SCENARIOS = {
    ...
    "conservative": Parameters(name="conservative",k_mean=100,k_sd=10,q_mean=.75,q_sd=.075,yield_mean_pct=23,yield_sd_pct=2.66,water_buffer_m=100,max_slope_deg=10,min_biomass_mg_cell=3,retained_pct=20),
    "intensive": Parameters(name="intensive",k_mean=80,k_sd=8,q_mean=.95,q_sd=.095,yield_mean_pct=18.2,yield_sd_pct=5.18,water_buffer_m=0,max_slope_deg=90,min_biomass_mg_cell=0,retained_pct=1),
}
...
def simulate(initial, reporting_mask, scheduled_year, eligible, p, draws, capture=None, compact=True):
